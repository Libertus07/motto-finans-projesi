...
export const useTransactionLogic = (transactions) => {
    ...
    const filteredAndSortedTransactions = useMemo(() => {
        ...
        return [...transactions].filter(t => {
            ...
            const timeA = a.timestamp?.seconds || new Date(a.date).getTime();
            const timeB = b.timestamp?.seconds || new Date(b.date).getTime();
