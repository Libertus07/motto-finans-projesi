// components/CategoryManagerModal.jsx (HIZLI SİLME & TOAST BİLDİRİMİ EKLENDİ ✅)

import React, { useState, useEffect } from 'react';
import { X, Plus, GripVertical, Trash2, LayoutList, Save, CheckCircle2 } from 'lucide-react'; // CheckCircle2 eklendi
...
const SortableCategoryItem = ({ category, onDelete }) => {
...
const CategoryManagerModal = ({ isOpen, onClose, currentCategories }) => {
    ...
    // --- FIREBASE GÜNCELLEME ---
    const saveToFirebase = async (updatedList) => {
        try {
            setIsSaving(true);
