// components/AuthScreen.jsx (SCROLL FIX & HIGH VISIBILITY PIN ✅)
...
const AuthScreen = ({ setUserRole }) => {
    ...
    const PINS = { 'kasiyer': '178600', 'garson': '325200' };
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-indigo-500/30">
            ...
            <div className="relative z-10 w-full max-w-[380px]">
                ...
                {/* Logo Area */}
                <div className={`text-center mb-6 space-y-3 transition-all duration-500 ${step === 'input' ? 'scale-90 opacity-80' : 'scale-100'}`}>
