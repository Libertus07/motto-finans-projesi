// components/pos/Loyalty/RegisterModal.tsx
import React, { useState, useEffect } from 'react';
import { X, UserPlus, ShieldCheck, Phone, Calendar } from 'lucide-react';

interface RegisterModalProps {
    isOpen: boolean;
    onClose: () => void;
    phone: string;
    onRegister: (data: { name: string; surname: string; phone: string; birthday: string }) => void;
    isDarkMode: boolean;
}

const RegisterModal: React.FC<RegisterModalProps> = ({ isOpen, onClose, phone: initialPhone, onRegister, isDarkMode }) => {
    // Form State'leri
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full h-16 pl-14 pr-6 rounded-3xl border-2 outline-none transition-all font-black text-lg tracking-widest ${isDarkMode
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input
                                ...
                                className={`w-full h-16 px-6 rounded-3xl border-2 outline-none transition-all font-bold ${isDarkMode
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full h-14 pl-12 pr-4 rounded-2xl border-2 outline-none transition-all font-bold ${isDarkMode ? 'bg-slate-900 border-white/5 text-white' : 'bg-slate-50 border-slate-100'
                                    }`}
                            />
                        </div>
                    </div>
