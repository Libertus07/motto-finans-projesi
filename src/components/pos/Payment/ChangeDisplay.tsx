// components/pos/Payment/ChangeDisplay.tsx
    ...
    return (
        ...
        `}>
            ...
            <div className="relative z-10 text-right pr-4">
                <span className={`text-[10px] uppercase font-bold ${isEnough ? 'text-emerald-500' : 'text-red-500'
                    }`}>
                    {isEnough ? 'PARA ÜSTÜ' : 'EKSİK'}
                </span>
                <span className={`block font-black text-2xl ${isEnough ? 'text-emerald-500' : 'text-red-500'
                    }`}>
