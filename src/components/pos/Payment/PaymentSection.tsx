// components/pos/Payment/PaymentSection.tsx
...
import { BankName, PaymentMethod, LoyaltyCustomer } from '../../../types';
...
interface PaymentSectionProps {
    ...
    loyaltyHook: any; // Using any for hook return type for now, as it returns many functions
    onRedeemPoints: (discountValue: number, usedPoints: number) => void;

    // Handlers
    onMethodChange: (method: PaymentMethod | 'mix') => void;
        ...
        <>
            ...
            <LoyaltyPointsSelector
                ...
                onConfirm={(points) => {
                    ...
                    loyaltyHook.redeemPoints(points, (discountValue: number, usedPoints: number) => {
