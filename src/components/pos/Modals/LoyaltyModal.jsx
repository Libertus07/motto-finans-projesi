...
import { X, Phone, Search, Zap, Gift, Crown, Star, ArrowRight, RotateCcw, Check, UserPlus } from 'lucide-react';
...
const LoyaltyModal = ({
    ...
    const handleNumpadInput = (value) => {
        let current = String(loyaltyPhone || '');
        if (value === 'C') {
            onPhoneChange('');
        } else if (value === 'BACK') {
                    ...
                    <div className="relative">
                        ...
                        <div className="relative z-10 flex flex-col items-center pt-8 px-6 pb-6 gap-6">
                            ...
                            <div className="w-full grid grid-cols-3 gap-2">
                                ...
                                <div className={`p-3 rounded-2xl flex flex-col items-center justify-center border ${isDarkMode ? 'bg-slate-800/30 border-white/5' : 'bg-slate-50 border-slate-200'}`}>
                                    <span className="text-[9px] font-bold text-slate-500 uppercase">Puan</span>
                            ...
                            <div className={`w-full p-4 rounded-2xl border flex items-center justify-between ${
                                ...
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-bold text-slate-500 uppercase">Mevcut Puan</span>
                                    <span className="text-3xl font-black text-yellow-500">{loyaltyCustomer.points || 0} P</span>
                                </div>
                            ...
                            <div className="w-full grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    <button 
                                        ...
                                        className={`p-3 rounded-xl border flex flex-col items-center gap-1 transition-all active:scale-95 disabled:opacity-30 ${
                                    ...
                                    >
                                        ...
                                        <span className="text-[10px] text-slate-500">{promo.p} Puan</span>
                                    </button>
                                ))}
                            </div>
