// components/pos/Cart/CartModeButtons.tsx
import React from 'react';
import { ListChecks, PieChart, Scissors } from 'lucide-react';
import ToolButton from '../shared/ToolButton';

interface CartModeButtonsProps {
    isDarkMode: boolean;
...
const CartModeButtons: React.FC<CartModeButtonsProps> = ({
    isDarkMode,
    isSelectionMode,
    isPartialMode,
    splitCount,
    ...
    return (
        <div className={`grid grid-cols-5 gap-2 p-2 border-t shrink-0 ${isDarkMode
