...
const LoyaltyDiscountDisplay = memo(({ loyaltyDiscount, onCancelLoyaltyDiscount, isDarkMode }) => {
        ...
        <div className={`relative overflow-hidden rounded-2xl border p-4 flex flex-col gap-2 transition-all duration-500 ${getBgClass()}`}>
            ...
            <div className="flex justify-between items-end mt-2">
                ...
                <div className="text-right flex flex-col gap-1">
                    ...
                    {loyaltyCustomer && loyaltyDiscount > 0 && <LoyaltyDiscountDisplay loyaltyDiscount={loyaltyDiscount} onCancelLoyaltyDiscount={onCancelLoyaltyDiscount} />}  
...
CartSummary.propTypes = {
    ...
    isPartialMode: PropTypes.bool,
    isSelectionMode: PropTypes.bool,
    currentPayable: PropTypes.number,
    paidSoFar: PropTypes.number,
    remainingDebt: PropTypes.number,
    discountAmount: PropTypes.number,
    splitCount: PropTypes.number,
    onClose: PropTypes.func,
    loyaltyCustomer: PropTypes.object,
    loyaltyDiscount: PropTypes.number,
    onCancelLoyaltyDiscount: PropTypes.func.isRequired,
};
