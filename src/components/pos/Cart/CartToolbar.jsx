...
const CartToolbar = ({ 
    ...
    return (
        <div className={`w-[70px] flex flex-col items-center py-4 gap-3 shrink-0 border-r transition-colors duration-500 overflow-y-auto max-h-[calc(100vh-200px)] ${
            isDarkMode
                ? 'bg-[#141824]/50 border-white/5'
