...
const CartPanel = ({ 
    ...
    return (
        <div className={`
            ...
            ${isDarkMode ? 'bg-[#0B0F17] border-white/10' : 'bg-white border-slate-200'}
        `}>
            ...
            <div className="flex-1 flex overflow-hidden relative">
                ...
                <LoyaltyPointsSelector
                    ...
                    onConfirm={(pts) => onRedeemPoints(pts * 0.5, pts)} //
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    <div className={`
                        ...
                        ${isDarkMode ? 'bg-[#0B0F17]' : 'bg-slate-50'}
                    `}>
                        {cart.length === 0 ? (
            ...
            <div className={`
                ...
                ${isDarkMode
                    ? 'bg-[#0B0F17] border-white/5 shadow-[0_-5px_30px_rgba(0,0,0,0.5)]'
