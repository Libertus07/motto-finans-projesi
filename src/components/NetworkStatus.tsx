...
type StatusType = 'online' | 'offline' | 'syncing' | 'restored';
...
const NetworkStatus: React.FC = () => {
    const [status, setStatus] = useState<StatusType>('online'); // online, offline, syncing
    ...
    const config: Record<StatusType, StatusConfigItem> = {
        online: { // Dummy default
            bg: 'bg-emerald-900/90',
            border: 'border-emerald-500/50',
            icon: <CheckCircle2 size={18} className="text-emerald-400" />,
            title: 'Çevrimiçi',
            desc: 'Sistem çevrimiçi',
