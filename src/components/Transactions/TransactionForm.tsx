...
interface TransactionFormProps {
    newTrans: TransactionFormData;
    setNewTrans: (data: TransactionFormData) => void;
    transferData: TransferData;
    setTransferData: (data: TransferData) => void;
    handleAddTransaction: () => void;
    handleAssetTransfer: () => void;
}
        ...
        <div className={`${THEME.card} p-6 rounded-[2.5rem] border ${THEME.border} h-fit shadow-2xl bg-slate-900/40 relative overflow-hidden`}>
            ...
            <div className="grid grid-cols-3 gap-2 bg-slate-950 p-1.5 rounded-2xl mb-8 border border-slate-800">
                <button
                    ...
                    className={`py-3 rounded-xl font-black text-[10px] transition-all flex items-center justify-center gap-2 ${newTrans.type === 'income'
                ...
                <button
                    ...
                    className={`py-3 rounded-xl font-black text-[10px] transition-all flex items-center justify-center gap-2 ${newTrans.type === 'expense'
                ...
                <button
                    ...
                    className={`py-3 rounded-xl font-black text-[10px] transition-all flex items-center justify-center gap-2 ${newTrans.type === 'transfer'
            ...
            {newTrans.type !== 'transfer' ? (
                <div className="space-y-6 animate-in fade-in duration-500">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            ...
                            {newTrans.type === 'income' && (
                                <button
                                    ...
                                    className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${newTrans.method === 'mix'
                            ...
                            <button
                                ...
                                className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${newTrans.method === 'card'
                            ...
                            <button
                                ...
                                className={`p-4 rounded-2xl border-2 transition-all flex flex-col items-center gap-2 ${newTrans.method === 'cash'
                    ...
                    <button
                        ...
                        className={`w-full py-5 rounded-[1.5rem] font-black text-lg shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 ${newTrans.type === 'income'
