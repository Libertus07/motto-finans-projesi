                ...
                {quickActions?.map((action) => (
                    <div key={action.id} className="relative shrink-0 snap-center group/item">
                        <button
                            ...
                            className={`flex flex-col items-center justify-center w-[110px] h-[110px] rounded-[2.5rem] border transition-all duration-300 relative overflow-hidden group/btn ${
                                isEditingShortcuts
                        ...
                        >
                            ...
                            <div className={`absolute top-4 right-4 w-1.5 h-1.5 rounded-full ${
                                action.type === 'income' ? 'bg-emerald-500 animate-pulse' : 'bg-rose-500'
                            }`}></div>
                        </button>
                        {isEditingShortcuts && (
                            <button
