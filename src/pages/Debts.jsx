...
const Debts = ({ debts }) => {
    ...
    // --- ÖDEME YAPMA ---
    const handleProcessPayment = async (payAmount, method, cardBank) => {
    ...
    // Not: Artık debts hook'tan ham veri olarak geliyor, burada işliyoruz.
    ...
    return (
        <div className="space-y-6 pb-20 animate-in fade-in">
            <ConfirmationModal isOpen={!!deleteId} onClose={() => setDeleteId(null)} onConfirm={handleDelete} title="Kaydı Sil" message="Bu kaydı silmek istediğinize emin misiniz?" type="danger"/>
            ...
            <PaymentModal
                ...
                onConfirm={handleProcessPayment} // Parametreleri PaymentModal'dan alacak
                loading={processing}
            />
