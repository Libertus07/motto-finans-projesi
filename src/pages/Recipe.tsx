// pages/Recipe.tsx (ORTAK HAVUZ ENTEGRASYONU ✅)
...
const Recipe: React.FC<RecipeProps> = ({ ingredients, products }) => {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-500">
            <ConfirmationModal isOpen={!!deleteId} onClose={() => setDeleteId(null)} onConfirm={confirmDelete} title="Malzeme Silinsin mi?" message="Bu malzemeyi silmek istediğinize emin misiniz? Reçeteler etkilenebilir." loading={false} />
