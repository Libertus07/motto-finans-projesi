// pages/Settings.tsx - PREMIUM VERSION
...
const Settings: React.FC<SettingsProps> = ({
    ...
    const [confirmModal, setConfirmModal] = useState<{
        ...
        open: false, type: 'info', title: '', message: '', action: null
    });
    ...
    // 💾 SAVE HANDLERS
    const handleUpdateGoal = async (val: string) => {
        const numVal = Number(val);
        setMonthlyGoal(numVal);
    ...
    const handleUpdateFixedCost = async (field: string, val: string) => {
    ...
    const handleUpdateLoyaltySetting = async (field: string, val: string) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#05070a] via-[#0a0d14] to-[#05070a] pb-20">
            ...
            <div className="max-w-6xl mx-auto px-6 py-8">
                ...
                {/* 💰 FINANCIAL SECTION */}
                {activeSection === 'financial' && <SettingsFinancial monthlyGoal={monthlyGoal} handleUpdateGoal={handleUpdateGoal} fixedCosts={fixedCosts} handleUpdateFixedCost={handleUpdateFixedCost} />}
