...
// 👇 YENİ BİLEŞEN: Banka Seçim Butonlarını Tekrar Kullanmak İçin
...
const Transactions = ({ transactions, quickActions, isPatron }) => {
    ...
    const handleAddTransaction = async () => {
        ...
        const newItem = {
            ...
            cardBank: newTrans.method === 'card' ? newTrans.cardBank : null, // ✅ Düzeltme: Seçili bankayı kullanır
                    ...
                    {newTrans.type === 'transfer' ? (
                        ...
                        {newTrans.type === 'income' && (
                            <div className="mb-6 space-y-4 bg-slate-800/50 p-5 rounded-xl border border-slate-700/50">
                                ...
                                {/* ✅ GÜNCELLENDİ: Banka Seçimi Eklendi */}
