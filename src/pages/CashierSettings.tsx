// pages/CashierSettings.tsx - PREMIUM VERSION
...
import {
    ...
    Activity, BarChart3, Package, Users, LucideIcon
} from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#05070a] via-[#0a0d14] to-[#05070a] pb-20">
            <ConfirmationModal
                ...
                type="warning"
                loading={loading}
                confirmText="Yenile" // Added confirmText
            />
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className={`text-xs font-bold mt-0.5 ${perm.granted ? 'text-emerald-400' : 'text-rose-400'
                                                                }`}>
